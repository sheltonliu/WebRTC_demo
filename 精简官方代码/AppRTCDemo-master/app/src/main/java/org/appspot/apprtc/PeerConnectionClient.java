...
public class PeerConnectionClient {
  ...
  private void createPeerConnectionInternal(EglBase.Context renderEGLContext) {
    ...
    //连接回调接口  创建PeerConnection的对象
    /**
     * rtcConfig: 配置参数，包括ice_server列表
     * pcConstraints：是媒体限制
     * pcObserver 监听回调
     */
    ...
    //其实 VideoTrack/AudioTrack 已经可以播放了，不过我们先不考虑本地播放。
    // 那么如果要把他们发送到对方客户端，我们需要把他们添加到媒体流
